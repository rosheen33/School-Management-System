<html>
	...
	<body align="left" background="LMS.jpg">
		...
		<h2 color="Blue" align="left">Books Return</h2>
		<form name="form7" id="form7" action="book_return" method="POST">
		
		<table border="0" align="left">
		   <tr >
			<td >
				Enter Id of a Memeber who issued book:
			</td> 
			<td>
		   ...
		   <tr align=center>
			...
			<td>
				<input type="submit"   onclick="verify()" value="Return_Book">
			</td>
		   </tr>
		</table>
